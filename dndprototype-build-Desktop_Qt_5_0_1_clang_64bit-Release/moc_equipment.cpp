...
#include "../dndprototype/equipment.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_Equipment_t, stringdata) + ofs \
...
QT_MOC_LITERAL(4, 49, 26)
    ...
    "Equipment\0on_btnBack_clicked\0\0"
...
const QMetaObject Equipment::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_Equipment.data,
      qt_meta_data_Equipment,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Equipment.stringdata))

...
struct qt_meta_stringdata_Spells_t {
    QByteArrayData data[5];
    char stringdata[74];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_Spells_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
static const qt_meta_stringdata_Spells_t qt_meta_stringdata_Spells = {
    {
...
QT_MOC_LITERAL(4, 46, 26)
    ...
    "Spells\0on_btnBack_clicked\0\0"
...
void Spells::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Spells *_t = static_cast<Spells *>(_o);
        switch (_id) {
...
const QMetaObject Spells::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_Spells.data,
      qt_meta_data_Spells,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Spells.stringdata))

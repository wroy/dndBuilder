...
#include "../dndprototype/charactersheet.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_CharacterSheet_t, stringdata) + ofs \
...
QT_MOC_LITERAL(2, 34, 0)
    ...
    "CharacterSheet\0on_btnBack_clicked\0\0"
};
...
void CharacterSheet::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        CharacterSheet *_t = static_cast<CharacterSheet *>(_o);
        switch (_id) {
...
const QMetaObject CharacterSheet::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_CharacterSheet.data,
      qt_meta_data_CharacterSheet,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_CharacterSheet.stringdata))
        return static_cast<void*>(const_cast< CharacterSheet*>(this));
